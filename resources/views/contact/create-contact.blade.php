		...
		<div class="navbar-form navbar-left" style="padding-left:0px;" >
			...
			<div class="form-group">
				  {!! Form::submit('Enregistrer + Ajouter un autre',[
				  	'type'=>'button', 
				  	'class' =>'btn btn-warning btn-smenu-position dropdown-toggle',
			...
			<div class="col-md-4">
				...
				<div class="form-group">
				    <div class="col-sm-12">
						...
						{!! Form::text('prenoms_contact',null, ['class' =>'form-control input-sm', 'placeholder' =>'A propos de la société']) !!}
					</div>
				</div>
				<div class="form-group">
				    <div class="col-sm-12">
				...
				<div class="form-group">
				    <div class="col-sm-12">
						...
						{!! Form::text('fonction_contact',null, ['class' =>'form-control input-sm', 'placeholder' =>'A propos de la société']) !!}
					</div>
				</div>
				<div class="form-group">
				    <div class="col-sm-12">
						{!! Form::label('service','Service') !!}
						{!! Form::text('service_contact',null, ['class' =>'form-control input-sm', 'placeholder' =>'A propos de la société']) !!}
					</div>
				</div>
				<div class="form-group">
				    <div class="col-sm-12">
						{!! Form::label('description','Description') !!}
						{!! Form::text('description_contact',null, ['class' =>'form-control input-sm', 'placeholder' =>'A propos de la société']) !!}
					</div>
				</div>
